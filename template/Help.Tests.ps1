...
$commands = Get-Command -Module (Get-Module $ModuleName) -CommandType Cmdlet, Function, Workflow  # Not alias

# Remember to restart session before a new round of tests
Write-Host ''
Write-Host 'When testing HELP, remember that help is cached at the beginning of each session. To test, restart session.' -f White
